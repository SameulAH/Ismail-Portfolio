  ...
  const experiences: Experience[] = [
    {
      ...
      dateEnded: "2025-05-01",
      isCurrentlyWorkingHere: false,
      jobTitle: "AI / Data Science Intern",
      points: [
        "Worked on large language models and applied data science methods to socio-economic datasets",
        "Developed NLP pipelines for analyzing research publications and policy documents",
        "Implemented machine learning models for predictive analytics on demographic data",
      ],
      technologies: [
        ...
        { _id: "tech5", title: "HPC", image: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/unix/unix-original.svg" },
