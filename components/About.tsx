  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        viewport={{ once: true }}
        className="-mb-24 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover object-top md:rounded-xl md:w-72 md:h-80 xl:w-[400px] xl:h-[480px] shadow-xl ring-2 ring-darkGreen/20"
